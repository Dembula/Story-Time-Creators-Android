...
import com.storytime.creators.core.model.MusicSelectionBody
import com.storytime.creators.core.model.MusicSelectionResponse
import com.storytime.creators.core.model.MusicTrack
import com.storytime.creators.core.network.get
import com.storytime.creators.core.network.post
import com.storytime.creators.core.util.formatTrackDuration
    ...
    selecting?.let { track ->
        ...
        if (router.selectedProjectId == null) {
            FormDialog("Select a project", { selecting = null }, false, onConfirm = {}) {
                androidx.compose.material3.Text("Open a project first to attach music.", color = com.storytime.creators.core.theme.STColor.textSecondary)
            }
        } else {
